    ...
    >
      <html lang="en">
        <body className={inter.className}>
            ...
            <div className="container mx-auto px-4 py-3 flex items-center justify-between">
              <div className="flex items-center">
                <div className="text-blue-900   font-bold text-xl">
                  American Express{" "}
                  <span className="text-blue-700">GBT Demo App </span>
                </div>
              </div>
              <nav className="hidden md:block">
                <ul className="flex space-x-6">
                  <li className="text-blue-900 font-medium text-sm">
                    Business Travel
                  </li>
                  <li className="text-blue-900 font-medium text-sm">
                    Corporate Solutions
          ...
          <main>{children}</main>
          <footer className="bg-blue-900 text-white py-4 mt-auto"></footer>
        </body>
      </html>
    </AuthProvider>
  );
